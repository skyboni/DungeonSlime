...
public class TitleScene : Scene
{
    ...
    public override void Initialize()
    {
        ...
        // While on the title screen, we can enable exit on escape so the player can close the game by pressing the escape key.
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        // Draw the Dungeon text slightly offset from it is original position and with a transparent color to give it a drop shadow.
