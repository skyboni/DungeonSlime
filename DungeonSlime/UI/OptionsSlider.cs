...
public class OptionsSlider : Slider
{
    ...
    private RectangleRuntime _fillRectangle;
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        _fillRectangle = new RectangleRuntime();
        ...
        enabled.Apply = () =>
        {
            ...
            _fillRectangle.FillColor = unfocusedColor;
            _fillRectangle.StrokeColor = unfocusedColor;
        };
        ...
        focused.Apply = () =>
        {
            ...
            _fillRectangle.FillColor = focusedColor;
            _fillRectangle.StrokeColor = focusedColor;
        };
